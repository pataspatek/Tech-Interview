...
def gpt_solution(num_array, target_sum):
    nums = []
...
def test():
    assert gpt_solution([3, 5, -4, 8, 11, 1, -1, 6], 10) == [-1, 11] or gpt_solution([3, 5, -4, 8, 11, 1, -1, 6], 10) == [11, -1]
    assert gpt_solution([4, 2, 3, 5, 1], 8) == [5, 3] or gpt_solution([4, 2, 3, 5, 1], 8) == [3, 5]
    assert gpt_solution([3, 4, 7, 10], 15) == []
